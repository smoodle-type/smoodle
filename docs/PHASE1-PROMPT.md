...
## OQ3 + OQ4 — RESOLVED 2026-05-05: Path A + lex/librime fork
...
- **Path A** schema (algebra rules stay) — best-practice Rime
  ...
  stays compact.
- **lex/librime fork** — soft-fork of rime/librime 1.16.0 with the
...
1. Fork `rime/librime` to `lex/librime` on GitHub.
...
2. Confirm fork status: has `lex/librime` been created + tagged
