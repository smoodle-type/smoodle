...
- Apple Developer ID notarization (deferred to v0.1.0 — v0.0.8 ships unsigned; recruits accept Gatekeeper warning)
- MSI / MAS / winget submission (pre-public-ship gate)
